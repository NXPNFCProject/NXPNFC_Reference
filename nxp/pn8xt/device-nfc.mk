...
# SE config files
PRODUCT_COPY_FILES += \
    hardware/nxp/secure_element/pn8x/libese-spi/p73/libese-nxp-P73.conf:vendor/etc/libese-nxp.conf


ifeq ($(NXP_NFC_HW),pn81T)
PRODUCT_COPY_FILES += \
    hardware/nxp/nfc/pn8x/halimpl/libnfc-nci_NCI2_0.conf:system/etc/libnfc-nci.conf \
    hardware/nxp/nfc/pn8x/halimpl/libnfc-nxp-PN81T_example.conf:vendor/etc/libnfc-nxp.conf \
    vendor/nxp/pn8xt/hw/hal_uuid_map_config.xml:vendor/etc/hal_uuid_map_config.xml

    ifeq ($(NXP_RF_REQ),true)
    PRODUCT_COPY_FILES += \
        hardware/nxp/nfc/pn8x/halimpl/libnfc-nxp_RF-PN81T_example.conf:vendor/libnfc-nxp_RF.conf
    endif

else
PRODUCT_COPY_FILES += \
    hardware/nxp/nfc/pn8x/halimpl/libnfc-nci.conf:system/etc/libnfc-nci.conf
    hardware/nxp/nfc/pn8x/halimpl/libnfc-nxp-PN80T_example.conf:vendor/etc/libnfc-nxp.conf \

    ifeq ($(NXP_RF_REQ),true)
    PRODUCT_COPY_FILES += \
        hardware/nxp/nfc/pn8x/halimpl/libnfc-nxp_RF-PN80T_example.conf:vendor/libnfc-nxp_RF.conf
    endif
