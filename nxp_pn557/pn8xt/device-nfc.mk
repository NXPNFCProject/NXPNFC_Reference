...
PRODUCT_COPY_FILES += \
    vendor/$(NXP_VENDOR_DIR)/pn557/hw/$(NXP_NFC_HW)/libnfc-nci_NCI2_0.conf:system/product/etc/libnfc-nci.conf \
    vendor/$(NXP_VENDOR_DIR)/pn557/hw/$(NXP_NFC_HW)/libnfc-nxp-PN557_example.conf:vendor/etc/libnfc-nxp.conf

	ifeq ($(NXP_RF_REQ),true)
    PRODUCT_COPY_FILES += \
	vendor/$(NXP_VENDOR_DIR)/pn557/hw/$(NXP_NFC_HW)/libnfc-nxp_RF-PN557_example.conf:vendor/libnfc-nxp_RF.conf
	endif
else
PRODUCT_COPY_FILES += \
